...
#define STRING_CONFIG_H_AUTHOR "Volca" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // E3D V6 Clone. Measured via M303
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // MK52 12V clone. Measured with M303
  #define DEFAULT_bedKp 117.50
  #define DEFAULT_bedKi 5.14
  #define DEFAULT_bedKd 671.39
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
// TODO(Volca): Might want to revisit these.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 0, -0.2 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (122)  // X point for Z homing when homing all axes (G28).
